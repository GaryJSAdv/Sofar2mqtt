...
Forked from https://github.com/cmcgerty/Sofar2mqtt to add support for the ESP32 and to compile in PlatformIO 


Supported models:  

ME3000SP - Untested support  
HYD-xx00-ES - No support in this fork. See the source project
