...
/*********************************************************************
I changed the adafruit SSD1306 to SH1106

The SH1106 driver is similar to SSD1306 so just change the display() method.

However, SH1106 driver doesn't provide several functions such as scroll commands.
